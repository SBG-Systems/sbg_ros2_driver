...
void utm::init(double latitude, double longitude, double altitude)
{
    int zoneNumber;
...
double utm::getEasting() const
{
    return easting_;
}

double utm::getNorthing() const
{
    return northing_;
}

double utm::getAltitude() const
{
    return altitude_;
}

int utm::getZone() const
{
    return zone_;
}
