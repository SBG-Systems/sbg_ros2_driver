...
const sensor_msgs::msg::Imu MessageWrapper::createRosImuMessage(const ImuSample& ref_imu_sample, const sbg_driver::msg::SbgEkfQuat& ref_sbg_quat_msg) const
{
  sensor_msgs::msg::Imu imu_ros_message;
  sbg_driver::msg::SbgEkfQuat ekf_quat_message_zero;

  imu_ros_message.header = ref_imu_sample.getHeader();

  imu_ros_message.angular_velocity          = ref_imu_sample.getAngularVelocity();
  imu_ros_message.linear_acceleration       = ref_imu_sample.getLinearAcceleration();
...
const nav_msgs::msg::Odometry MessageWrapper::createRosOdoMessage(const ImuSample &ref_imu_sample, const sbg_driver::msg::SbgEkfNav &ref_ekf_nav_msg, const sbg_driver::msg::SbgEkfQuat &ref_ekf_quat_msg, const sbg_driver::msg::SbgEkfEuler &ref_ekf_euler_msg)
{
  ...
  return createRosOdoMessage(ref_imu_sample, ref_ekf_nav_msg, orientation, ref_ekf_euler_msg);
}

const nav_msgs::msg::Odometry MessageWrapper::createRosOdoMessage(const ImuSample &ref_imu_sample, const sbg_driver::msg::SbgEkfNav &ref_ekf_nav_msg, const sbg_driver::msg::SbgEkfEuler &ref_ekf_euler_msg)
{
...
const nav_msgs::msg::Odometry MessageWrapper::createRosOdoMessage(const ImuSample &ref_imu_sample, const sbg_driver::msg::SbgEkfNav &ref_ekf_nav_msg, const tf2::Quaternion &ref_orientation, const sbg_driver::msg::SbgEkfEuler &ref_ekf_euler_msg)
{
  ...
  odo_ros_msg.header = ref_imu_sample.getHeader();
  ...
  odo_ros_msg.twist.twist.angular       = ref_imu_sample.getAngularVelocity();
...
const sensor_msgs::msg::Temperature MessageWrapper::createRosTemperatureMessage(const ImuSample& ref_imu_sample) const
{
  sensor_msgs::msg::Temperature temperature_message;

  temperature_message.header      = ref_imu_sample.getHeader();
  temperature_message.temperature = ref_imu_sample.getTemperature();
...
const geometry_msgs::msg::TwistStamped MessageWrapper::createRosTwistStampedMessage(const sbg_driver::msg::SbgEkfEuler& ref_sbg_ekf_euler_msg, const sbg_driver::msg::SbgEkfNav& ref_sbg_ekf_nav_msg, const ImuSample& ref_imu_sample) const
{
  ...
  return createRosTwistStampedMessage(res, ref_imu_sample);
}

const geometry_msgs::msg::TwistStamped MessageWrapper::createRosTwistStampedMessage(const sbg_driver::msg::SbgEkfQuat& ref_sbg_ekf_quat_msg, const sbg_driver::msg::SbgEkfNav& ref_sbg_ekf_nav_msg, const ImuSample& ref_imu_sample) const
{
  sbg::SbgMatrix3f tdcm;
...
const geometry_msgs::msg::TwistStamped MessageWrapper::createRosTwistStampedMessage(const sbg::SbgVector3f& body_vel, const ImuSample& ref_imu_sample) const
{
  geometry_msgs::msg::TwistStamped twist_stamped_message;

  twist_stamped_message.header        = ref_imu_sample.getHeader();
  twist_stamped_message.twist.angular = ref_imu_sample.getAngularVelocity();
